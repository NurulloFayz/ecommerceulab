...
import 'package:ecommerce_ulab/controller/provider/internet_connection_provider.dart';
...
class _EmailPageState extends State<EmailPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<InternetStateProvider>(

      builder: (context,internetState,child) {
        final connectivity = internetState.connectivity;
